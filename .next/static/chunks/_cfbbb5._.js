(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_cfbbb5._.js", {
...
function ContactPage() {
    ...
    const submit = async (formData)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$email$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendEmailAction"])(formData).then((response)=>{
            if (response.sonuc) {
                /*Başarılı mesajını gösterir, Toaster kullandım*/ toast.success("Email gönderildi!");
                /*Sayfayı yeniler*/ router.replace("/contact");
            } else {
...
_s(ContactPage, "CuHC/gmkH7n0V0sJOkcbkPBFVeg=", false, function() {
    return [
...
//# sourceMappingURL=_cfbbb5._.js.map