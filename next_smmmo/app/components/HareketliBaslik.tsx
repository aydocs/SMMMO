...
import styles from "./HareketliBaslik.module.css";

interface Props {
  yazilar: Array<string>;
}

export default function HareketliBaslik({ yazilar }: Props) {
  ...
  return (
    <h1 className={currentClass + " mb-4 animated-text"}>{currentText}</h1>
  );
}
